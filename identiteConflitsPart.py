...
class RepetitionsIC(Base):
    ...
    IC_decision_same_1_time = Column(Integer)
    IC_decision_same_2 = Column(Integer)
    IC_decision_same_2_time = Column(Integer)
    IC_decision_same_3 = Column(Integer)
    IC_decision_same_3_time = Column(Integer)
    IC_decision_same_4 = Column(Integer)
    IC_decision_same_4_time = Column(Integer)
    IC_decision_same_5 = Column(Integer)
    IC_decision_same_5_time = Column(Integer)
    IC_decision_same_6 = Column(Integer)
    IC_decision_same_6_time = Column(Integer)
    IC_decision_mixed_1 = Column(Integer)
    IC_decision_mixed_1_time = Column(Integer)
    IC_decision_mixed_2 = Column(Integer)
    IC_decision_mixed_2_time = Column(Integer)
    IC_decision_mixed_3 = Column(Integer)
    IC_decision_mixed_3_time = Column(Integer)
    IC_decision_mixed_4 = Column(Integer)
    IC_decision_mixed_4_time = Column(Integer)
    IC_decision_mixed_5 = Column(Integer)
    IC_decision_mixed_5_time = Column(Integer)
    IC_decision_mixed_6 = Column(Integer)
    IC_decision_mixed_6_time = Column(Integer)
    IC_decision_mixed_7 = Column(Integer)
    IC_decision_mixed_7_time = Column(Integer)
    IC_decision_mixed_8 = Column(Integer)
    IC_decision_mixed_8_time = Column(Integer)
    IC_decision_mixed_9 = Column(Integer)
    IC_decision_mixed_9_time = Column(Integer)
    IC_decision_mixed_10 = Column(Integer)
    IC_decision_mixed_10_time = Column(Integer)
    IC_decision_mixed_11 = Column(Integer)
    IC_decision_mixed_11_time = Column(Integer)
    IC_decision_mixed_12 = Column(Integer)
    IC_decision_mixed_12_time = Column(Integer)
    IC_decision_different_1 = Column(Integer)
    IC_decision_different_1_time = Column(Integer)
    IC_decision_different_2 = Column(Integer)
    IC_decision_different_2_time = Column(Integer)
    IC_decision_different_3 = Column(Integer)
    IC_decision_different_3_time = Column(Integer)
    IC_decision_different_4 = Column(Integer)
    IC_decision_different_4_time = Column(Integer)
    IC_decision_different_5 = Column(Integer)
    IC_decision_different_5_time = Column(Integer)
    IC_decision_different_6 = Column(Integer)
    IC_decision_different_6_time = Column(Integer)
